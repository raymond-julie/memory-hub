...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("participant_ids", ARRAY(sa.Text), nullable=False, server_default=sa.text("'{}'")),
    ...
    op.create_table(
        ...
        sa.Column("thread_id", UUID(as_uuid=True), nullable=False),
        sa.Column("source_messages", ARRAY(sa.Integer), nullable=False, server_default=sa.text("'{}'")),
